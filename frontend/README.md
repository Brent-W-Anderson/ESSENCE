...
##### &nbsp;&nbsp;&nbsp;&nbsp;🔹[**APP**](https://github.com/Brent-W-Anderson/ESSENCE/tree/main) (Frontend Development) ➜ This repo contains all frontend-related code, including UI components, styles, and client-side logic.
